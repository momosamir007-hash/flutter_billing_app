                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${state.cartItems.fold<int>(0, (sum, item) => sum + item.quantity)} قطعة',
                          style: TextStyle(
                            fontSize: 12,
                    ...
                    child: product.imagePath != null && product.imagePath!.isNotEmpty
                        ? ClipRRect(
                            ...
                            child: Image.file(File(product.imagePath!), fit: BoxFit.cover,
                              errorBuilder: (context, error, stackTrace) => Icon(Icons.inventory_2_outlined, size: 29, color: AppTheme.primaryColor),
                            ),
                          )
                        : Icon(Icons.inventory_2_outlined, size: 29, color: AppTheme.primaryColor),
                  ),
                ),
              ),
